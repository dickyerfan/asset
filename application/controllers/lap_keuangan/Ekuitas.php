    ...
    public function input_ppyd_neraca($tahun, $total_seluruh_ppyd_tahun_ini)
    {
        ...
        if ($query->num_rows() > 0) {
            ...
            $data = [
                ...
                'nilai_neraca_audited' => $total_seluruh_ppyd_tahun_ini,
                'posisi' => 28,
                'no_neraca' => '5.1',
                'status' => 1,
    ...
    public function input_ppybds_neraca($tahun, $total_seluruh_ppybds_tahun_ini)
    {
        ...
        if ($query->num_rows() > 0) {
            ...
            $data = [
                ...
                'nilai_neraca_audited' => $total_seluruh_ppybds_tahun_ini,
                'posisi' => 29,
                'no_neraca' => '5.2',
                'status' => 1,
                'created_at' => date('Y-m-d H:i:s'),
    ...
    public function input_mh_neraca($tahun, $total_seluruh_mh_tahun_ini)
    {
        ...
        if ($query->num_rows() > 0) {
            ...
            $data = [
                ...
                'nilai_neraca_audited' => $total_seluruh_mh_tahun_ini,
                'posisi' => 30,
                'no_neraca' => '5.2.1',
                'status' => 1,
                'created_at' => date('Y-m-d H:i:s'),
    ...
    public function input_cu_neraca($tahun, $total_seluruh_cu_tahun_ini)
    {
        ...
        if ($query->num_rows() > 0) {
            ...
            $data = [
                ...
                'nilai_neraca_audited' => $total_seluruh_cu_tahun_ini,
                'posisi' => 31,
                'no_neraca' => '5.3',
                'status' => 1,
                'created_at' => date('Y-m-d H:i:s'),
    ...
    public function input_aktl_neraca($tahun, $total_seluruh_aktl_tahun_ini)
    {
        ...
        if ($query->num_rows() > 0) {
            ...
            $data = [
                ...
                'nilai_neraca_audited' => $total_seluruh_aktl_tahun_ini * -1,
                'posisi' => 34,
                'no_neraca' => '5.4.2',
                'status' => 1,
                'created_at' => date('Y-m-d H:i:s'),
