    ...
    public function input_hnu_neraca($tahun, $total_seluruh_hnu_tahun_ini)
    {
        ...
        if ($query->num_rows() > 0) {
            ...
            $data = [
                ...
                'nilai_neraca_audited' => $total_seluruh_hnu_tahun_ini,
                'posisi' => 18,
                'no_neraca' => '3.2',
                'status' => 1,
    ...
    public function input_bymhd_neraca($tahun, $total_bymhd_tahun_ini)
    {
        ...
        if ($query->num_rows() > 0) {
            ...
            $data = [
                ...
                'nilai_neraca_audited' => $total_bymhd_tahun_ini,
                'posisi' => 19,
                'no_neraca' => '3.3',
                'status' => 1,
                'created_at' => date('Y-m-d H:i:s'),
    ...
    public function input_up_neraca($tahun, $total_up_tahun_ini)
    {
        ...
        if ($query->num_rows() > 0) {
            ...
            $data = [
                ...
                'nilai_neraca_audited' => $total_up_tahun_ini,
                'posisi' => 20,
                'no_neraca' => '3.4',
                'status' => 1,
                'created_at' => date('Y-m-d H:i:s'),
    ...
    public function input_kll_neraca($tahun, $total_kll_tahun_ini)
    {
        ...
        if ($query->num_rows() > 0) {
            ...
            $data = [
                ...
                'nilai_neraca_audited' => $total_kll_tahun_ini,
                'posisi' => 27,
                'no_neraca' => '4.3.1',
                'status' => 1,
                'created_at' => date('Y-m-d H:i:s'),
