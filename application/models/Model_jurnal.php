...
class Model_jurnal extends CI_Model
{
    ...
    //         // Hitung data berdasarkan logika penyusutan yang ada
    //         $umur_tahun = $tahun_lap - $row->tahun;
    //         $nilai_buku_awal = $row->rupiah;
    //         $akm_thn_ini = 0;
    //         $nilai_buku_final = $nilai_buku_awal;

    //         if ($umur_tahun > 0) {
    //             for ($i = 1; $i <= $umur_tahun; $i++) {
    //                 $akm_thn_ini += round(($row->persen_susut / 100) * $nilai_buku_awal);
    //                 $nilai_buku_final = $nilai_buku_awal - $akm_thn_ini;
    //                 if ($i > $row->umur) {
    //                     $nilai_buku_final = max(1, $nilai_buku_final);
    //                     break;
    //                 }
    //             }
    //         }

    //         // Tambahkan data ke kelompok
    //         if (!isset($grouped_data[$bagian_upk])) {
    //             $grouped_data[$bagian_upk] = [];
    //             $totals[$bagian_upk] = [
    //                 'total_rupiah' => 0,
    //                 'total_nilai_buku' => 0,
    //             ];
    ...
    //         $grouped_data[$bagian_upk][] = $row;

    //         // Update total untuk bagian_upk ini
    //         $totals[$bagian_upk]['total_rupiah'] += $row->rupiah;
    //         $totals[$bagian_upk]['total_nilai_buku'] += $nilai_buku_final;
    //     }
