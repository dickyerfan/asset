...
class Model_labarugi extends CI_Model
{
    ...
    // kode awal untuk perhitungan evkin
    // public function hitung_laba_rugi_bersih($tahun)
    // {
    //     $lr_sak_ep = $this->get_all_sak_ep($tahun);
    ...
    //         'beban_usaha' => $total_beban_usaha_audited + $total_beban_umum_administrasi_audited
    //     ];
    // }
    ...
    // kode akhir untuk perhitungan evkin
}
