...
class Model_penyusutan extends CI_Model
{
    ...
    public function get_all_non_amdk($tahun_lap)
    {
        $this->db->select('
            penyusutan.*, 
            daftar_asset.*, 
    ...
    public function get_all_amdk($tahun_lap)
    {
        $this->db->select('
            penyusutan.*, 
            daftar_asset.*, 
    ...
    public function get_tanah_amdk($tahun_lap)
    {
        $this->db->select('
        penyusutan.*, 
        daftar_asset.*, 
    ...
    public function get_tanah_non_amdk($tahun_lap)
    {
        $this->db->select('
        penyusutan.*, 
        daftar_asset.*, 
