...
class Model_penyusutan_bangunan extends CI_Model
{
    ...
    public function get_bangunan($tahun_lap)
    {
        ...
        // Daftar ID parent untuk bangunan
        $parent_ids_bangunan = [1569, 1907, 2104, 2255, 2671, 2674, 2676, 2678, 2680];
    ...
    public function get_bangunan_non_amdk($tahun_lap)
    {
        $this->db->select('
        penyusutan.*, 
        daftar_asset.*, 
    ...
    public function get_bangunan_amdk($tahun_lap)
    {
        $this->db->select('
        penyusutan.*, 
        daftar_asset.*, 
    ...
    public function get_bangunan_bagian($parent_id, $tahun_lap, $upk_bagian)
    {
        $this->db->select('*');
        $this->db->from('penyusutan');
        $this->db->join('daftar_asset', 'daftar_asset.id_asset = penyusutan.id_asset', 'left');
    ...
    public function get_bangunan_bagian_total($parent_id, $tahun_lap)
    {
        $this->db->select('*');
        $this->db->from('penyusutan');
        $this->db->join('daftar_asset', 'daftar_asset.id_asset = penyusutan.id_asset', 'left');
