...
class Model_penyusutan_inventaris extends CI_Model
{
    ...
    //         // // Kode gagal============================================
    //         // // 🔒 LOCK DINAMIS ASET DIHAPUS DI TAHUN PEROLEHAN
    //         // // Berlaku untuk semua tahun & semua umur
    //         // // ======================================================

    //         // $tahun_final = (int)$row->tahun + (int)$row->umur;

    //         // if (
    //         //     (int)$row->status_penyusutan == 2 &&                 // sudah dihapus
    //         //     (int)$row->tahun_persediaan == (int)$row->tahun &&   // hapus di tahun perolehan
    //         //     (int)$tahun >= $tahun_final                           // sudah masuk tahun final
    //         // ) {
    //         //     // 🔒 NILAI FINAL
    //         //     $row->nilai_buku_final = -1;
    //         //     $row->akm_thn_ini      = (int)$row->rupiah - (-1);
    ...
    //         // // kode gagal==========================================
    //         // // 🔴 KODE KHUSUS HARDCODED (CASE 2020–2020–UMUR 4)
    //         // // ======================================================
    //         // if (
    //         //     (int)$row->status_penyusutan == 2 &&
    //         //     (int)$row->tahun == 2020 &&
    //         //     (int)$row->tahun_persediaan == 2020 &&
    //         //     (int)$row->umur == 4
    //         // ) {
    //         //     // Tahun FINAL ABSOLUT = 2024
    //         //     if ((int)$tahun >= 2024) {
