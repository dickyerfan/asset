...
class Model_penyusutan_olah_air extends CI_Model
{
    public function get_olah_air($tahun_lap)
    {
        ...
        $akm_runtime = []; // penampung AKM terakhir per asset
        ...
        foreach ($results as &$row) {
            ...
            // // ======================================================
            // // 🔒 FINAL STATUS = 2 (PENGURANGAN)
            // // 🔒 untuk pengurangan yang sudah belum habis umurnya
            // // 🔒 LOCK AUDIT YEAR = 2024
            // // ======================================================
            // if ($row->status_penyusutan == 2) {

            //     $tahun_lap     = (int)$tahun;
            //     $tahun_event   = (int)$row->tahun_persediaan;
            //     $tahun_audit   = 2024;

            //     $pengurangan  = abs((int)$row->rupiah);
            //     $akm_final    = - ($pengurangan - 1);

            //     // ----------------------------------
            //     // 1️⃣ TAHUN AUDIT & SEBELUMNYA (LOCK TOTAL)
            //     // ----------------------------------
            //     if ($tahun_lap <= $tahun_audit) {

            //         // ❗ JANGAN sentuh hasil audit
            //         // Biarkan nilai dari DB / hasil lama
            //         // HANYA pastikan pengurangan muncul di tahun event

            //         if ($tahun_lap == $tahun_event) {
            //             $row->pengurangan = $pengurangan;
            //         } else {
            //             $row->pengurangan = 0;
            //         }

            //         // ❌ TIDAK hitung AKM baru
            //         continue; // keluar dari loop row
            //     }

            //     // ----------------------------------
            //     // 2️⃣ SETELAH AUDIT YEAR
            //     // ----------------------------------
            //     // Patokan: AKM Thn Ini 2024 = 0
            //     if ($tahun_lap == $tahun_event + 1) {
    ...
    // // kode paling mendekati nilainya jika tidak ada pengurangan aset
    // public function get_olah_air($tahun_lap)
    // {
    //     $this->db->select('
    //     penyusutan.*, 
    ...
    public function get_olah_air_amdk($tahun_lap)
    {
        $this->db->select('
        penyusutan.*, 
        daftar_asset.*, 
    ...
    public function get_olah_air_non_amdk($tahun_lap)
    {
        $this->db->select('
        penyusutan.*, 
        daftar_asset.*, 
    ...
    public function get_olah_air_bagian($parent_id, $tahun_lap, $upk_bagian)
    {
        $this->db->select('*');
        $this->db->from('penyusutan');
        $this->db->join('daftar_asset', 'daftar_asset.id_asset = penyusutan.id_asset', 'left');
    ...
    public function get_olah_air_bagian_total($parent_id, $tahun_lap)
    {
        $this->db->select('*');
        $this->db->from('penyusutan');
        $this->db->join('daftar_asset', 'daftar_asset.id_asset = penyusutan.id_asset', 'left');
        ...
        foreach ($results as &$row) {
            ...
            // // 38 -1
            // // =====================================
            // // LOGIKA FINAL PENGHAPUSAN (status = 2)
            // // =====================================
            // if ($row->status == 2) {

            //     $rupiah = (float)$row->rupiah;
            ...
            //     // Residu sesuai permintaan Anda = -1
            //     $nilai_buku_fix = -1;

            //     // Akumulasi penyusutan final
            //     // contoh: -(23.918.537 - 1) = -23.918.536
            //     $akm_fix = - ($rupiah - 1);
            ...
            //         $row->akm_thn_lalu = 0;
            //         $row->nilai_buku_lalu = $rupiah;

            //         $row->pengurangan = -$rupiah;
            //         $row->penambahan_penyusutan = 0;

            //         $row->akm_thn_ini = $akm_fix;         // -23.918.536
            //         $row->nilai_buku_final = $nilai_buku_fix; // -1
            ...
            //     // ---------------------------------------------------
            //     // TAHUN SETELAH PENGHAPUSAN
            //     // ---------------------------------------------------
            //     if ($tahun_lap > $tahun_hapus) {

            //         $row->akm_thn_lalu = $akm_fix;
            //         $row->nilai_buku_lalu = $nilai_buku_fix;

            //         $row->penambahan_penyusutan = 0;
            //         $row->pengurangan = 0;

            //         $row->akm_thn_ini = $akm_fix;
            //         $row->nilai_buku_final = $nilai_buku_fix;
            ...
            //     // ---------------------------------------------------
            //     // TAHUN SEBELUM PENGHAPUSAN (normal)
            //     // ---------------------------------------------------
            // }
