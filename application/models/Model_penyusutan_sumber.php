...
class Model_penyusutan_sumber extends CI_Model
{
    ...
    public function get_sumber_amdk($tahun_lap)
    {
        // $this->db->select('*');
        $this->db->select('
        penyusutan.*, 
    ...
    public function get_sumber_non_amdk($tahun_lap)
    {
        // $this->db->select('*');
        $this->db->select('
        penyusutan.*, 
    ...
    public function get_sumber_bagian($parent_id, $tahun_lap, $upk_bagian)
    {
        $this->db->select('*');
        $this->db->from('penyusutan');
        $this->db->join('daftar_asset', 'daftar_asset.id_asset = penyusutan.id_asset', 'left');
    ...
    public function get_sumber_bagian_total($parent_id, $tahun_lap)
    {
        $this->db->select('*');
        $this->db->from('penyusutan');
        $this->db->join('daftar_asset', 'daftar_asset.id_asset = penyusutan.id_asset', 'left');
