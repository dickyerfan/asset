...
class Model_penyusutan_trans_dist extends CI_Model
{
    ...
    //         //     (int)$tahun == $tahun_final
    //         // ) {
    //         //     // JANGAN set akm_thn_ini di sini
    //         //     $row->nilai_buku_final = 1;

    //         //     // Matikan pergerakan SETELAH tahun ini
    //         //     $row->penambahan_penyusutan = 0;
    //         //     $row->penambahan  = 0;
    //         //     $row->pengurangan = 0;

    //         //     $is_tahun_habis = true; // penanda saja
    //         // }
    ...
    //             // hanya untuk tahun SETELAH HABIS
    //             $row->akm_thn_ini = (int)$row->rupiah - $row->nilai_buku_final;
    ...
    // kode terakhir tetapi akm thn ini tidak sesuai
    // public function get_trans_dist($tahun_lap)
    // {
    //     $this->db->select('
    //     penyusutan.*, 
    ...
    public function get_trans_dist_bagian($parent_id, $tahun_lap, $upk_bagian)
    {
        $this->db->select('*');
        $this->db->from('penyusutan');
        $this->db->join('daftar_asset', 'daftar_asset.id_asset = penyusutan.id_asset', 'left');
    ...
    public function get_trans_dist_bagian_total($parent_id, $tahun_lap)
    {
        $this->db->select('*');
        $this->db->from('penyusutan');
        $this->db->join('daftar_asset', 'daftar_asset.id_asset = penyusutan.id_asset', 'left');
