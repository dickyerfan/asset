    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="accordion" id="accordionFolder">
                <?php
                $folderIndex = 0;
                foreach ($arsip_by_folder as $nama_folder => $arsip_list) :
                    $folderIndex++;
                ?>
                    <div class="card mb-2">
                        <div class="card-header bg-primary text-white" id="heading<?= $folderIndex ?>">
                            <h5 class="mb-0">
                                <button class="btn btn-link text-white" style="text-decoration: none; font-size: 1.1rem; font-weight: bold" type="button" data-toggle="collapse" data-target="#collapse<?= $folderIndex ?>" aria-expanded="true" aria-controls="collapse<?= $folderIndex ?>">
                                    <?= strtoupper($nama_folder); ?>
                                </button>
                            </h5>
                        </div>

                        <div id="collapse<?= $folderIndex ?>" class="collapse" aria-labelledby="heading<?= $folderIndex ?>" data-parent="#accordionFolder">
                            <div class="card-body">
