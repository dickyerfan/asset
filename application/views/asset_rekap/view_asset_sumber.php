    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header card-outline card-primary">
                <nav class="navbar ">
                    <a href="<?= base_url('asset_rekap/sumber') ?>"><button class="neumorphic-button">Tahun ini</button></a>
                    <form id="form_tahun" action="<?= base_url('asset_rekap/sumber'); ?>" method="get">
                    ...
                    <div class="navbar-nav ms-2">
                        <a href="<?= base_url('asset_rekap/sumber_kurang') ?>"><button class="float-end neumorphic-button"><i class="fas fa-minus"></i> Rekap Pengurangan</button></a>
                    </div>
                    <div class="navbar-nav ms-auto">
                        <a href="<?= base_url('asset_rekap/cetak_sumber') ?>" target="_blank"><button class="float-end neumorphic-button"><i class="fas fa-print"></i> Cetak Asset</button></a>
                    </div>
                </nav>
            </div>
