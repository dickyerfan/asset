...
<body>
    ...
    <div class="judul">
        ...
        ?>
        <?php if ($selected_upk) : ?>
            <h5 style="text-align: center;"><?= strtoupper($title . ' INVENTARIS : ' . ' ' . $selected_upk->name)  . ' ' . $tahun_lap; ?></h5>
        <?php else : ?>
            <h5 style="text-align: center;"><?= strtoupper($title)  . ' INVENTARIS : RUPA-RUPA LAINNYA' . ' ' . $tahun_lap; ?></h5>
        <?php endif; ?>
    </div>
