    ...
    <table class="table tableUtama">
        ...
        <tbody>
            ...
            foreach ($grouped_data as $parent_id => $upk_data) {
                ...
                echo "<tr><td class='bg-primary'></td><td colspan='13' class='bg-primary text-white' style='background-color:grey;'><strong>{$nama_kendaraan_jenis}</strong></td></tr>";
            ...
            ?>
                ...
                <tr class="bg-info text-right">
                    <td></td>
                    <td colspan="2" style="text-align: left;"><strong>Sub Total <?= $nama_kendaraan_jenis; ?></strong></td>
                    <td></td>
                    <td></td>
        ...
        <tfoot>
            <tr class="text-center bg-light">
                <th colspan="5" style="text-align: left;">Total Kendaraan</th>
