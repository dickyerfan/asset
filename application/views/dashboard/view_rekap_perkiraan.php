            ...
            <div class="card-body">
                <div class="row justify-content-center">
                    <div class="col-lg-6 text-center">
                        <h5><?= strtoupper($title) . ' TAHUN ' . $tahun_lap; ?> <br> ( Berdasarkan Kode Perkiraan )</h5>
                    </div>
                </div>
                <div class="table-responsive">
                    <table id="contoh2" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td class="bg-primary text-white" colspan="10"><strong>1. Tanah</strong></td>
                            </tr>
                            <?php
                            $no = 1;
                            $grouped_data = [];
                            ...
                            ?>
                                ...
                                ?>
                                <tr class="text-right">
                                    <td class="text-left"><strong><?= $nama_tanah_jenis; ?></strong></td>
                        ...
                        <tbody>
                            <tr>
                                <td class="bg-primary text-white" colspan="10"><strong>2. Bangunan Gedung</strong></td>
                            </tr>
                            <?php
                            $no = 1;
                            $grouped_data = [];
                            ...
                            ?>
                                ...
                                ?>
                                <tr class="text-right">
                                    <td class="text-left"><strong><?= $nama_bangunan_jenis; ?></strong></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_nilai_buku'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_penambahan'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_pengurangan'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_rupiah'], 0, ',', '.'); ?></td>
                        ...
                        <tbody>
                            <tr>
                                <td class="bg-primary text-white" colspan="10"><strong>3. Instalasi Sumber</strong></td>
                            </tr>
                            <?php
                            $no = 1;
                            $grouped_data = [];
                            ...
                            ?>
                                ...
                                ?>
                                <tr class="text-right">
                                    <td class="text-left"><strong><?= $nama_sumber_jenis; ?></strong></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_nilai_buku'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_penambahan'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_pengurangan'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_rupiah'], 0, ',', '.'); ?></td>
                        ...
                        <tbody>
                            <tr>
                                <td class="bg-primary text-white" colspan="10"><strong>4. Instalasi Pompa</strong></td>
                            </tr>
                            <?php
                            $no = 1;
                            $grouped_data = [];
                            ...
                            ?>
                                ...
                                ?>
                                <tr class="text-right">
                                    <td class="text-left"><strong><?= $nama_pompa_jenis; ?></strong></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_nilai_buku'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_penambahan'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_pengurangan'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_rupiah'], 0, ',', '.'); ?></td>
                        ...
                        <tbody>
                            <tr>
                                <td class="bg-primary text-white" colspan="10"><strong>5. Instalasi Pengolahan Air</strong></td>
                            </tr>
                            <?php
                            $no = 1;
                            $grouped_data = [];
                            ...
                            ?>
                                ...
                                ?>
                                <tr class="text-right">
                                    <td class="text-left"><strong><?= $nama_olah_air_jenis; ?></strong></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_nilai_buku'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_penambahan'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_pengurangan'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_rupiah'], 0, ',', '.'); ?></td>
                        ...
                        <tbody>
                            <tr>
                                <td class="bg-primary text-white" colspan="10"><strong>6. Instalasi Transmisi & Distribusi</strong></td>
                            </tr>
                            <?php
                            $no = 1;
                            $grouped_data = [];
                            ...
                            ?>
                                ...
                                ?>
                                <tr class="text-right">
                                    <td class="text-left"><strong><?= $nama_trans_dist_jenis; ?></strong></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_nilai_buku'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_penambahan'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_pengurangan'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_rupiah'], 0, ',', '.'); ?></td>
                        ...
                        <tbody>
                            <tr>
                                <td class="bg-primary text-white" colspan="10"><strong>7. Peralatan & Perlengkapan</strong></td>
                            </tr>
                            <?php
                            $no = 1;
                            $grouped_data = [];
                            ...
                            ?>
                                ...
                                ?>
                                <tr class="text-right">
                                    <td class="text-left"><strong><?= $nama_peralatan_jenis; ?></strong></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_nilai_buku'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_penambahan'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_pengurangan'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_rupiah'], 0, ',', '.'); ?></td>
                        ...
                        <tbody>
                            <tr>
                                <td class="bg-primary text-white" colspan="10"><strong>8. Kendaraan & Alat Angkut</strong></td>
                            </tr>
                            <?php
                            $no = 1;
                            $grouped_data = [];
                            ...
                            ?>
                                ...
                                ?>
                                <tr class="text-right">
                                    <td class="text-left"><strong><?= $nama_kendaraan_jenis; ?></strong></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_nilai_buku'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_penambahan'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_pengurangan'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_rupiah'], 0, ',', '.'); ?></td>
                        ...
                        <tbody>
                            <tr>
                                <td class="bg-primary text-white" colspan="10"><strong>9. Inventaris/Perabotan Kantor</strong></td>
                            </tr>
                            <?php
                            $no = 1;
                            $grouped_data = [];
                            ...
                            ?>
                                ...
                                ?>
                                <tr class="text-right">
                                    <td class="text-left"><strong><?= $nama_inventaris_jenis; ?></strong></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_nilai_buku'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_penambahan'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_pengurangan'], 0, ',', '.'); ?></td>
                                    <td><?= number_format($totals_per_jenis[$parent_id]['total_rupiah'], 0, ',', '.'); ?></td>
