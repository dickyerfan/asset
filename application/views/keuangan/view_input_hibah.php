        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header card-outline card-primary shadow">
                    ...
                    <a href="<?= base_url('keuangan/hibah'); ?>"><button class=" neumorphic-button float-right"><i class="fas fa-reply"></i> Kembali</button></a>
                </div>
                <div class="card-body">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- <input type="text" class="form-control" id="uraian" name="uraian" placeholder="Masukan Jenis Asset" value="<?= set_value('uraian'); ?>"> -->
                                    <textarea class="form-control" name="uraian" id="uraian" rows="8" cols="80" placeholder="Masukkan isi berita...">  <?= set_value('uraian') ?></textarea>
