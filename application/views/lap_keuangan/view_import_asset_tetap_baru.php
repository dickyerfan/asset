<section class="content">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= base_url('lap_keuangan/asset_tetap_baru/import'); ?>" method="POST">
                    <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="data_excel" name="data_excel" rows="14" placeholder="Nama Asset	Harga Perolehan	Akm Penyusutan"><?= set_value('data_excel'); ?></textarea>
                        <small class="form-text text-danger pl-3"><?= form_error('data_excel'); ?></small>
                    </div>
                    <div class="alert alert-info">
                        Urutan kolom: Nama Asset, Harga Perolehan, Akm Penyusutan. Nilai buku dihitung otomatis. Baris Total atau Jumlah akan dilewati otomatis.
                    </div>
