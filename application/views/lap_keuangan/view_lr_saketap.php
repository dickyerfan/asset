    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header card-outline card-primary">
                <nav class="navbar ">
                    <form id="form_tahun" action="<?= base_url('lap_keuangan/lr_saketap'); ?>" method="get">
                    ...
                    <a href="<?= base_url('lap_keuangan/lr_saketap') ?>" style="text-decoration: none;"><button class="neumorphic-button ms-2"> Tahun ini</button></a>
                    <div class="navbar-nav ms-auto ">
                        <a href="<?= base_url('lap_keuangan/lr_saketap_cetak'); ?>" target="_blank"><button class=" neumorphic-button float-right"><i class="fas fa-print"></i> Cetak</button></a>
                    </div>
                </nav>
            </div>
            <div class="card-body">
                <div class="row justify-content-center">
                    <div class="col-lg-12 text-center">
                        ...
                        <h5><strong>(Berdasarkan SAK ETAP)</strong></h5>
                    </div>
                </div>
                    ...
                    <table id="contoh2" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr class="text-center">
                                ...
                                <th>Uraian</th>
                                <th>Catatan</th>
                                <th>31/12/<?= $tahun_lap ?></th>
                                <th>31/12/<?= $tahun_lalu ?></th>
                            </tr>
                        </thead>
                        <!-- <tbody>
