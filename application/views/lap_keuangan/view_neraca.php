            ...
            <div class="card-header card-outline card-primary">
                <nav class="navbar ">
                    ...
                    <div class="navbar-nav ms-auto ">
                        <a href="<?= base_url('lap_keuangan/neraca_cetak'); ?>" target="_blank"><button class=" neumorphic-button float-right"><i class="fas fa-print"></i> Cetak</button></a>
                    </div>
            ...
            <div class="card-body">
                <div class="row justify-content-center">
                    <div class="col-lg-12 text-center">
                        ...
                        <h5><strong>Per 31 Desember <?= $tahun_lap ?> dan <?= $tahun_lalu ?></strong></h5>
                    </div>
                </div>
