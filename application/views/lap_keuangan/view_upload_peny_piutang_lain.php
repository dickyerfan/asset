<section class="content">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="user" action="<?= base_url('lap_keuangan/peny_piutang_baru/input_peny_piutang_lain'); ?>" method="POST">
                    <div class="row justify-content-center">
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                <label for="tahun">Tahun :</label>
                                <input type="number" class="form-control" id="tahun" name="tahun" placeholder="Masukan Tahun" min="2022" max="2099" value="<?= set_value('tahun', date('Y')); ?>">
                                <small class="form-text text-danger pl-3"><?= form_error('tahun'); ?></small>
                            </div>
                            <div class="form-group">
                                <label for="nilai_neraca">Nilai Penyisihan Piutang Lain-lain :</label>
                            ...
                            <div class="alert alert-info">
                                Nilai akan disimpan ke Neraca sebagai angka minus.
                            </div>
                        </div>
                    </div>
                    <div class="row justify-content-center">
