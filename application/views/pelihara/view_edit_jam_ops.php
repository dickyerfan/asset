    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="user" action="<?= site_url('pelihara/jam_ops/update_jo') ?>" method="post">
                    <input type="hidden" name="id_sb_mag" value="<?= $id_sb_mag; ?>">
                    <input type="hidden" name="tgl_jam_ops" value="<?= $tgl_jam_ops; ?>">
                    <input type="hidden" name="field" value="jumlah_jam_ops">
                    <div class="row">
                        <div class="col-md-2">
