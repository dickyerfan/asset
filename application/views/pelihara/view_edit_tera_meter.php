    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="user" action="<?= site_url('pelihara/water_meter/update_tm') ?>" method="post">
                    <input type="hidden" name="id_bagian" value="<?= $id_bagian; ?>">
                    <input type="hidden" name="tgl_tm" value="<?= $tgl_tm; ?>">
                    <input type="hidden" name="field" value="jumlah_tm">
                    <div class="row">
                        <div class="col-md-2">
