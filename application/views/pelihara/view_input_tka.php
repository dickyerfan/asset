                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="tahun_tka" name="tahun_tka" placeholder="Masukan Tahun" min="2022" max="2099" value="<?= set_value('tahun_tka'); ?>">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="jumlah_cek" name="jumlah_cek" placeholder="Masukan Jumlah" value="<?= set_value('jumlah_cek'); ?>">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="jumlah_07" name="jumlah_07" placeholder="Masukan Jumlah" value="<?= set_value('jumlah_07'); ?>">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="jumlah_sr_70" name="jumlah_sr_70" placeholder="Masukan Jumlah" value="<?= set_value('jumlah_sr_70'); ?>">
