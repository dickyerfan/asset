    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header card-outline card-primary">
                <nav class="navbar ">
                    <form id="form_tahun" action="<?= base_url('penyusutan/inventaris'); ?>" method="get">
                    ...
                    <div class="navbar-nav ms-1">
                        <a href="<?= base_url('penyusutan/inventaris') ?>" style="text-decoration: none;"><button class=" neumorphic-button"> Tahun ini</button></a>
                    </div>
                    <div class="navbar-nav ms-1">
                        <a href="<?= base_url('penyusutan/inventaris_meubelair') ?>" style="text-decoration: none;"><button class=" neumorphic-button"> Meubelair</button></a>
                    </div>
                    <div class="navbar-nav ms-1">
                        <a href="<?= base_url('penyusutan/inventaris_mesin') ?>" style="text-decoration: none;"><button class=" neumorphic-button"> Mesin Kantor</button></a>
                    </div>
                    <div class="navbar-nav ms-1">
                        <a href="<?= base_url('penyusutan/inventaris_rupa') ?>" style="text-decoration: none;"><button class=" neumorphic-button"> Rupa-rupa</button></a>
                    </div>
                    <div class="navbar-nav ms-auto">
                        <a href="<?= base_url('penyusutan/cetak_inventaris') ?>" target="_blank"><button class="float-end neumorphic-button"><i class="fas fa-print"></i> Cetak Asset</button></a>
                    </div>
                </nav>
            </div>
                    ...
                    <table id="contoh2" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            foreach ($grouped_data as $parent_id => $upk_data) {
                                ...
                                $nama_inventaris_jenis = $nama_inventaris[$parent_id] ?? "Bangunan Lainnya";
                                echo "<tr><td class='bg-primary'></td><td colspan='13' class='bg-primary text-white'><strong>{$nama_inventaris_jenis}</strong></td></tr>";
                            ...
                            ?>
                                ...
                                <tr class="bg-info text-right">
                                    <td></td>
                                    <td colspan="2" class="text-left"><strong>Sub Total <?= $nama_inventaris_jenis; ?></strong></td>
                                    <td></td>
                                    <td></td>
