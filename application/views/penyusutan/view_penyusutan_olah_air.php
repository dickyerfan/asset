    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header card-outline card-primary">
                <nav class="navbar ">
                    <form id="form_tahun" action="<?= base_url('penyusutan/olah_air'); ?>" method="get">
                    ...
                    <div class="navbar-nav ms-1">
                        <a href="<?= base_url('penyusutan/olah_air') ?>" style="text-decoration: none;"><button class=" neumorphic-button"> Tahun ini</button></a>
                    </div>
                    <div class="navbar-nav ms-1">
                        <a href="<?= base_url('penyusutan/olah_air_bangunan') ?>" style="text-decoration: none;"><button class=" neumorphic-button"> Bang & prbaikan</button></a>
                    </div>
                    <div class="navbar-nav ms-1">
                        <a href="<?= base_url('penyusutan/olah_air_alat') ?>" style="text-decoration: none;"><button class=" neumorphic-button"> Alat Pengolahan</button></a>
                    </div>
                    <div class="navbar-nav ms-1">
                        <a href="<?= base_url('penyusutan/olah_air_reservoir') ?>" style="text-decoration: none;"><button class=" neumorphic-button"> Reservoir</button></a>
                    </div>
                    <div class="navbar-nav ms-1">
                        <a href="<?= base_url('penyusutan/olah_air_inst_lain') ?>" style="text-decoration: none;"><button class=" neumorphic-button"> Inst. Lainnya</button></a>
                    </div>
                    <div class="navbar-nav ms-auto">
                        <a href="<?= base_url('penyusutan/cetak_olah_air') ?>" target="_blank"><button class="float-end neumorphic-button"><i class="fas fa-print"></i> Cetak Asset</button></a>
                    </div>
                </nav>
            </div>
                    ...
                    <table id="contoh2" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            foreach ($grouped_data as $parent_id => $upk_data) {
                                ...
                                $nama_olah_air_jenis = $nama_olah_air[$parent_id] ?? "Bangunan Lainnya";
                                echo "<tr><td class='bg-primary'></td><td colspan='13' class='bg-primary text-white'><strong>{$nama_olah_air_jenis}</strong></td></tr>";
                            ...
                            ?>
                                ...
                                <tr class="bg-info text-right">
                                    <td></td>
                                    <td colspan="2" class="text-left"><strong>Sub Total <?= $nama_olah_air_jenis; ?></strong></td>
                                    <td></td>
                                    <td></td>
