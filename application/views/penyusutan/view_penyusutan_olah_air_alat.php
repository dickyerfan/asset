    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header card-outline card-primary">
                <nav class="navbar ">
                    <form id="form_tahun" action="<?= base_url('penyusutan/olah_air_alat'); ?>" method="get">
                    ...
                    <div class="navbar-nav ms-2">
                        <form id="form_upk_bagian" action="<?= base_url('penyusutan/olah_air_alat'); ?>" method="get">
                            <div style="display: flex; align-items: center;">
                    ...
                    <div class="navbar-nav ms-2">
                        <a href="<?= base_url('penyusutan/olah_air_alat') ?>" style="text-decoration: none;"><button class=" neumorphic-button"> Tahun ini</button></a>
                    </div>
                    <div class="navbar-nav ms-2">
                        <a href="<?= base_url('penyusutan/olah_air_alat') ?>" style="text-decoration: none;"><button class=" neumorphic-button"> Total olah_air alat</button></a>
                    </div>
                    <div class="navbar-nav ms-2">
                    ...
                    <div class="navbar-nav ms-auto">
                        <a href="<?= base_url('penyusutan/cetak_olah_air_alat') ?>" target="_blank"><button class="float-end neumorphic-button"><i class="fas fa-print"></i> Cetak Asset</button></a>
                    </div>
                </nav>
            </div>
            ...
            <div class="card-body">
                <div class="row justify-content-center">
                    <div class="col-lg-6 text-center">
                        ...
                        <?php else : ?>
                            <h5><?= strtoupper($title)  . ' INSTALASI PENGOLAHAN AIR : ALAT-ALAT PENGOLAHAN AIR' . ' ' . $tahun_lap; ?></h5>
                        <?php endif; ?>
                    </div>
                </div>
