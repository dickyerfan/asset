        ...
        <div class="card">
            <div class="card-header card-outline card-primary">
                <nav class="navbar ">
                    ...
                    <div class="navbar-nav ms-1">
                        <a href="<?= base_url('penyusutan/sumber_bangunan') ?>" style="text-decoration: none;"><button class=" neumorphic-button"> Bang & prbaikan</button></a>
                    </div>
                    <div class="navbar-nav ms-1">
                        <a href="<?= base_url('penyusutan/sumber_reservoir') ?>" style="text-decoration: none;"><button class=" neumorphic-button"> Reservoir</button></a>
                    </div>
                    <!-- <div class="navbar-nav ms-1">
                        <a href="<?= base_url('penyusutan/sumber_danau') ?>" style="text-decoration: none;"><button class=" neumorphic-button"> Danau & Sungai</button></a>
                    </div>
                    <div class="navbar-nav ms-1">
                        <a href="<?= base_url('penyusutan/sumber_mata_air') ?>" style="text-decoration: none;"><button class=" neumorphic-button"> Mata Air</button></a>
                    </div> -->
                    <div class="navbar-nav ms-1">
                        <a href="<?= base_url('penyusutan/sumber_sumur') ?>" style="text-decoration: none;"><button class=" neumorphic-button"> Sumur2</button></a>
                    </div>
                    <div class="navbar-nav ms-1">
                        <a href="<?= base_url('penyusutan/sumber_pipa') ?>" style="text-decoration: none;"><button class=" neumorphic-button"> Pipa Supply</button></a>
                    </div>
                    <div class="navbar-nav ms-1">
                        <a href="<?= base_url('penyusutan/sumber_inst_lain') ?>" style="text-decoration: none;"><button class=" neumorphic-button"> Inst. Lainnya</button></a>
                    </div>
                    <div class="navbar-nav ms-auto">
                        <a href="<?= base_url('penyusutan/cetak_sumber') ?>" target="_blank"><button class="float-end neumorphic-button"><i class="fas fa-print"></i> Cetak Asset</button></a>
                    </div>
                </nav>
            </div>
                    ...
                    <table id="contoh2" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            foreach ($grouped_data as $parent_id => $upk_data) {
                                ...
                                $nama_sumber_jenis = $nama_sumber[$parent_id] ?? "Bangunan Lainnya";
                                echo "<tr><td class='bg-primary'></td><td colspan='13' class='bg-primary text-white'><strong>{$nama_sumber_jenis}</strong></td></tr>";
                            ...
                            ?>
                                ...
                                <tr class="bg-info text-right">
                                    <td></td>
                                    <td colspan="2" class="text-left"><strong>Sub Total <?= $nama_sumber_jenis; ?></strong></td>
                                    <td></td>
                                    <td></td>
                        ...
                        <tfoot>
                            <tr class="text-center bg-light">
                                <th colspan="5" class="text-left">Total Instalasi Sumber</th>
