                    ...
                    <div class="col-md-6">
                        <form method="post">
                            <div class="form-group mb-2">
                                ...
                                <input type="number" name="probabilitas" class="form-control" value="<?= isset($matrik) ? $matrik->probabilitas : '' ?>">
                                <small class="form-text text-danger pl-3"><?= form_error('probabilitas'); ?></small>
                            </div>
                            <div class="form-group mb-2">
                                <label>Dampak</label>
                                <input type="number" name="dampak" class="form-control" value="<?= isset($matrik) ? $matrik->dampak : '' ?>">
                                <small class="form-text text-danger pl-3"><?= form_error('dampak'); ?></small>
                            </div>
                            <div class="form-group mb-2">
                                <label>Skor</label>
                                <input type="number" name="skor" class="form-control" value="<?= isset($matrik) ? $matrik->skor : '' ?>">
                                <small class="form-text text-danger pl-3"><?= form_error('skor'); ?></small>
                            </div>
                            <div class="form-group mb-2">
                                <label>Level Risiko</label>
                                <input type="number" name="level_risiko" class="form-control" value="<?= isset($matrik) ? $matrik->level_risiko : '' ?>">
                                <small class="form-text text-danger pl-3"><?= form_error('level_risiko'); ?></small>
                            </div>
                            <div class="form-group mb-2">
                                <label>Nama Level</label>
                                <input type="text" name="nama_level" class="form-control" value="<?= isset($matrik) ? $matrik->nama_level : '' ?>">
