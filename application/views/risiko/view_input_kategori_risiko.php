                        ...
                        <div class="col-md-6">
                            <form method="post">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="kategori_kr" class="form-control" value="<?= isset($kategori) ? $kategori->kategori_kr : '' ?>">
                                ...
                                <div class="form-group">
                                    <label>Status</label>
                                    <select name="status_kr" id="" class="form-control">
                                        <option value="1" <?= isset($kategori) && $kategori->status_kr == '1' ? 'selected' : '' ?>>Aktif</option>
                                        <option value="0" <?= isset($kategori) && $kategori->status_kr == '0' ? 'selected' : '' ?>>Tidak Aktif</option>
                                    </select>
