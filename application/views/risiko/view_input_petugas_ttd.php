                        ...
                        <form method="post">
                            <div class="form-group mb-2">
                                ...
                                <select name="kode_ttd" class="form-control">
                                    ...
                                    <option value="pemilik_risiko" <?= set_select('kode_ttd', 'pemilik_risiko') ?>>Pemilik Risiko</option>
                                    <option value="ketua_satgas_mr" <?= set_select('kode_ttd', 'ketua_satgas_mr') ?>>Ketua Satgas MR</option>
                                    <option value="ketua_spi" <?= set_select('kode_ttd', 'ketua_spi') ?>>Ketua SPI</option>
                                    <option value="direktur" <?= set_select('kode_ttd', 'direktur') ?>>Direktur</option>
                                </select>
                                <small class="form-text text-danger pl-3"><?= form_error('kode_ttd'); ?></small>
                            </div>
                            <div class="form-group mb-2">
                                <label>Jabatan TTD</label>
                                <input type="text" name="jabatan_ttd" class="form-control" value="<?= set_value('jabatan_ttd') ?>">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <select name="id_bagian" class="form-control">
                                    ...
                                    <?php foreach ($bagian as $bag) : ?>
                                        <option value="<?= $bag->id_bagian ?>" <?= set_select('id_bagian', $bag->id_bagian) ?>>
                                            <?= $bag->nama_bagian ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
