...
<body>
    ...
    <div class="judul">
        <p class="my-2 text-center fw-bold"><?= strtoupper($title); ?> <br> <?= strtoupper($nama_bulan_terpilih); ?> <?= $tahun_selected; ?></p>
    </div>
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td style="text-align: center;"><?= $data_upk['total_skor_teknis']; ?></td>
                        <td style="text-align: center;"><?= $data_upk['total_skor_admin']; ?></td>
                        <td style="text-align: center;"><?= $data_upk['total_skor_koordinasi']; ?></td>
                        <td style="text-align: center;"><?= $data_upk['grand_total_skor']; ?></td>
                        <td style="text-align: center;"><?= $hasil; ?></td>
                    </tr>
                <?php endforeach;
            else : ?>
                <tr>
                    <td colspan="7" class="text-center">Tidak ada data yang ditemukan untuk bulan dan tahun ini.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
