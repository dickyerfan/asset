    ...
    <table class="table tableUtama">
        ...
        <tfoot>
            <tr>
                ...
                <th style="text-align: center;"><?= $total_skor_admin; ?></th>
            </tr>
        </tfoot>
    </table>
    <br>
    <table class="table tableUtama">
        ...
        <tfoot>
            <tr>
                ...
                <th style="text-align: center;"><?= $total_skor_koordinasi; ?></th>
            </tr>
        </tfoot>
    </table>
    <br>
    <table class="table tableUtama">
        ...
        <tbody>
            ...
            foreach ($detail_tindak_lanjut as $tl) : ?>
                <tr>
                    <td style="text-align: center;"><?= $no_tl++; ?></td>
                    <td><?= $tl->temuan; ?></td>
                    <td><?= $tl->rekomendasi; ?></td>
                    <td style="text-align: center;"><?= $tl->keterangan; ?></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
