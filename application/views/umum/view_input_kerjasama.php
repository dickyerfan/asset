                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="tahun_perjanjian" name="tahun_perjanjian" placeholder="Masukan Tahun" min="2022" max="2099" value="<?= set_value('tahun_perjanjian'); ?>">
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="no_perjanjian" name="no_perjanjian" placeholder="Masukan No Perjanjian" value="<?= set_value('no_perjanjian'); ?>">
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="tentang_perjanjian" name="tentang_perjanjian" placeholder="Masukan Tentang Perjanjian" value="<?= set_value('tentang_perjanjian'); ?>">
